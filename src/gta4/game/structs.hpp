...
namespace gta4::game
{
	...
	// for CurrentRenderStates map @ reinterpret_cast<int*>(0x106B420);
	enum D3DRS_INDEX_MAPPING
	{
		D3DRS_Z_ENABLE = 0x0,
		D3DRS_FILL_MODE = 0x1,
		D3DRS_Z_WRITE_ENABLE = 0x2,
		D3DRS_ALPHA_TEST_ENABLE = 0x3,
		D3DRS_SRC_BLEND = 0x4,
		D3DRS_DEST_BLEND = 0x5,
		D3DRS_CULL_MODE = 0x6,
		D3DRS_Z_FUNC = 0x7,
		D3DRS_ALPHA_REF = 0x8,
		D3DRS_ALPHA_FUNC = 0x9,
		D3DRS_ALPHA_BLEND_ENABLE = 0xA,
		D3DRS_STENCIL_ENABLE = 0xB,
		D3DRS_STENCIL_FAIL = 0xC,
		D3DRS_STENCIL_Z_FAIL = 0xD,
		D3DRS_STENCIL_PASS = 0xE,
		D3DRS_STENCIL_FUNC = 0xF,
		D3DRS_STENCIL_REF = 0x10,
		D3DRS_STENCIL_MASK = 0x11,
		D3DRS_STENCIL_WRITE_MASK = 0x12,
		D3DRS_COLOR_WRITE_ENABLE = 0x13,
		D3DRS_COLOR_WRITE_ENABLE1 = 0x14,
		D3DRS_COLOR_WRITE_ENABLE2 = 0x15,
		D3DRS_COLOR_WRITE_ENABLE3 = 0x16,
		D3DRS_BLEND_OP = 0x17,
		D3DRS_BLEND_OP_ALPHA = 0x18,
		D3DRS_SEPARATE_ALPHA_BLEND_ENABLE = 0x19,
		D3DRS_SRC_BLEND_ALPHA = 0x1A,
		D3DRS_DEST_BLEND_ALPHA = 0x1B,
		D3DRS_PAD_0 = 0x1C,
		D3DRS_SLOPE_SCALE_DEPTH_BIAS = 0x1D,
		D3DRS_DEPTH_BIAS = 0x1E,
		D3DRS_BLEND_FACTOR = 0x1F,
		D3DRS_PAD_1 = 0x20,
		D3DRS_PAD_2 = 0x21,
		D3DRS_PAD_3 = 0x22,
		D3DRS_TWO_SIDED_STENCIL_MODE = 0x23,
		D3DRS_CCW_STENCIL_FAIL = 0x24,
		D3DRS_CCW_STENCIL_Z_FAIL = 0x25,
		D3DRS_CCW_STENCIL_PASS = 0x26,
		D3DRS_CCW_STENCIL_FUNC = 0x27,
		D3DRS_COUNT = 0x28,
	};
}
